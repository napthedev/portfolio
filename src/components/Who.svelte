  ...
  <div>
    ...
    <div class="text-3xl flex gap-[10px] mt-[15px] mb-[25px]" id="role">
      ...
      <div class="h-[35px]">
        {#key role}
          <p
            class="relative after:h-1 after:rounded after:bg-primary after:absolute after:top-[105%] after:left-1/2 after:-translate-x-1/2 after:animate-expand-delay after:w-0"
